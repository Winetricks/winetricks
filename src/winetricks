...
load_nuget()
{
    ...
    w_download https://nuget.org/nuget.exe 9bc98ced9c2d2b51ab687f86b5580913c025b8b0
...
load_shockwave() {
    ...
    w_download http://fpdownload.macromedia.com/get/shockwave/default/english/win95nt/latest/sw_lic_full_installer.msi ae2855b729bfaedc766f3addd8c2b74eac576909
...
load_mingw()
{
    ...
    w_try mkdir -p "$W_DRIVE_C/MinGW"
    w_try tar -C "$W_DRIVE_C/MinGW" -Jxvf "$W_CACHE/mingw/$file1"
...
load_braid_demo()
{
    ...
    then
        w_download http://media1.gamefront.com/worthplaying/braid/Braid_PC_Demo.exe 27f78feb37c856fa901d7802a6889d262e44c827
    fi
...
load_kotor2()
{
    ...
    w_download ftp://ftp.lucasarts.com/patches/pc/KotOR2%20Patch%20v201420%20UK.exe ab97a0d41ae15782418d0fd1b2ad43ccf35ca070
